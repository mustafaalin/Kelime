...
public class MainActivity extends AppCompatActivity {
    ...
    TextView txtKelime, txtSeviye, txtScore, txtHigh, txtTopScore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtHigh = (TextView) findViewById(R.id.txtHigh2);
       ...
       public void startTimer(){
            countDownTimer=new CountDownTimer(timeLeftInMiliseconds,1000) {
                ...
                public void onTick(long l) {
                    ...
                    if(btnAtla.getVisibility() == View.VISIBLE){
                        stopTimer();
                        sure = (Integer.toString(seconds));
                    }
                }
    ...
    public void oyna(){
        if(seviye==1){
            ...
            if(kontrol1 != 0 && kontrol2 != 0){
                ...
                kontrol1=0;
                kontrol2=0;
                score = high - (2*gonderBtnTiklama) - 60 + seconds;
                int scoreEski = sharedPref.getInt("level1",0);
                if(scoreEski > score){
                    editor.putInt("level1", scoreEski);
                }else{
                ...
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level1",0)));
                txtTopScore.setText(""+topScore);
        ...
        if(seviye==2){
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0){
                ...
                kontrol3=0;
                score = high - (2*gonderBtnTiklama) - 60 + seconds;
                int scoreEski = sharedPref.getInt("level2",0);
                if(scoreEski > score){
                    editor.putInt("level2", scoreEski);
                }else{
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level2",0)));
                txtTopScore.setText(""+topScore);
        ...
        if(seviye==3){
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0){
                ...
                kontrol3=0;
                score = high - (2*gonderBtnTiklama) - 60 + seconds;
                int scoreEski = sharedPref.getInt("level3",0);
                if(scoreEski > score){
                    editor.putInt("level3", scoreEski);
                }else{
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level3",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==4){
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0){
                ...
                int scoreEski = sharedPref.getInt("level4",0);
                if(scoreEski > score){
                    editor.putInt("level4", scoreEski);
                }else{
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level4",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==5){
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0){
                ...
                int scoreEski = sharedPref.getInt("level5",0);
                if(scoreEski > score){
                    editor.putInt("level5", scoreEski);
                }else{
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level5",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==6){
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0){
                ...
                int scoreEski = sharedPref.getInt("level6",0);
                if(scoreEski > score){
                    editor.putInt("level6", scoreEski);
                }else{
                    editor.putInt("level6", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level6",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==7){
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0){
                ...
                int scoreEski = sharedPref.getInt("level7",0);
                if(scoreEski > score){
                    editor.putInt("level7", scoreEski);
                }else{
                    editor.putInt("level7", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level7",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==8){ // CEZA, ECZA, EZA, CAZ
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0){
                ...
                int scoreEski = sharedPref.getInt("level8",0);
                if(scoreEski > score){
                    editor.putInt("level8", scoreEski);
                }else{
                    editor.putInt("level8", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level8",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==9){ // KITA, TAKI, KATI, ATIK
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0){
                ...
                int scoreEski = sharedPref.getInt("level9",0);
                if(scoreEski > score){
                    editor.putInt("level9", scoreEski);
                }else{
                    editor.putInt("level9", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level9",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==10){ // DAM, DAMA, ADAM, ADA
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0){
                ...
                int scoreEski = sharedPref.getInt("level10",0);
                if(scoreEski > score){
                    editor.putInt("level10", scoreEski);
                }else{
                    editor.putInt("level10", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level10",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==11){
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0){
                ...
                int scoreEski = sharedPref.getInt("level11",0);
                if(scoreEski > score){
                    editor.putInt("level11", scoreEski);
                }else{
                    editor.putInt("level11", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level11",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==12){ //BOYA, BOY, OBA, BAY, OYA
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0 && kontrol5 != 0){
                ...
                int scoreEski = sharedPref.getInt("level12",0);
                if(scoreEski > score){
                    editor.putInt("level12", scoreEski);
                }else{
                    editor.putInt("level12", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level12",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==13){
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 ){
                ...
                int scoreEski = sharedPref.getInt("level13",0);
                if(scoreEski > score){
                    editor.putInt("level13", scoreEski);
                }else{
                    editor.putInt("level13", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level13",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==14){ // KÖPEK, KEK, PEK, KÖK
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0 ){
                ...
                int scoreEski = sharedPref.getInt("level14",0);
                if(scoreEski > score){
                    editor.putInt("level14", scoreEski);
                }else{
                    editor.putInt("level14", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level14",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==15){ // BİTKİ, BİTİK, BİT, TİK
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0 ){
                ...
                int scoreEski = sharedPref.getInt("level15",0);
                if(scoreEski > score){
                    editor.putInt("level15", scoreEski);
                }else{
                    editor.putInt("level15", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level15",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==16){ // MİLYON, İYON, LİMON, MİL, YOL,
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0 && kontrol5 != 0 ){
                ...
                int scoreEski = sharedPref.getInt("level16",0);
                if(scoreEski > score){
                    editor.putInt("level16", scoreEski);
                }else{
                    editor.putInt("level16", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level16",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==17){ // SORUN, SORU, ONUR, RUS, SON, SUR
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0 && kontrol5 != 0 && kontrol6 !=0){
                ...
                int scoreEski = sharedPref.getInt("level17",0);
                if(scoreEski > score){
                    editor.putInt("level17", scoreEski);
                }else{
                    editor.putInt("level17", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level17",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
        ...
        if(seviye==18){
            ...
            if(kontrol1 != 0 && kontrol2 != 0 && kontrol3 != 0 && kontrol4 != 0 && kontrol5 != 0 ){
                ...
                int scoreEski = sharedPref.getInt("level18",0);
                if(scoreEski > score){
                    editor.putInt("level18", scoreEski);
                }else{
                    editor.putInt("level18", score);
                }
                editor.commit();
                stopTimer();
                ...
                topScore += score;
                txtScore.setText(""+score);
                txtHigh.setText("HighScore: "+Integer.toString(sharedPref.getInt("level18",0)));
                txtTopScore.setText(""+topScore);
                btnAtla.setVisibility(View.VISIBLE);
                gonderBtnTiklama =0;
